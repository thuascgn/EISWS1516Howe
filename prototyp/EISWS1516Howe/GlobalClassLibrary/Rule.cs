...
namespace GlobalClassLibrary
{
    public class Rule
    {
        ...
        public Rule(int id, string conditionSender, string conditionKeywordAccountingText, string conditionKeycharsDocumentNumber,
                    string attributionDepartment, string attributionContactPerson, string attributionProjectNumber, 
    ...
    public class Attribution {
        ...
        public Attribution()
        {
            Department = ContactPerson = Account = CostCenter = ProjectNumber = @"";
        }

        public Attribution(string department, string contactPerson, string projectNumber, string account, string costCenter) {
