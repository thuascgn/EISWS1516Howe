...
namespace RuleService.Providers
{
    public class RuleProvider
    {
        ...
        private static String RuleConnection = "server=localhost;port=9001;user id=admin;pwd=rak20adm/n16;database=rules;";
        ...
        public long Create(Rule rule)
        {
            ...
            SqlCmd = "INSERT INTO tbl_rules (id, condition_Sender, condition_KeywordAccoutingText, condition_KeycharsDocumentNumber,"
        ...
        internal Rule Check(Document document)
        {
            ...
            SqlCmd = "SELECT * FROM tbl_rules WHERE condition_sender LIKE \""+ document.Sender +"\" AND attribution_department NOT LIKE \"\" "
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        rule.Attribution.ProjectNumber = (int)reader[6];
        ...
        public Rule Read(int Id)
        {
            ...
            SqlCmd = "SELECT * FROM tbl_rules WHERE id =" + Id + ";";
        ...
        {
            int success = -1;
            SqlCmd = "UPDATE tbl_rules SET condition_Sender='" + rule.Condition.Sender + "', condition_KeywordAccountingText='" + rule.Condition.KeywordAccountingText 
        ...
        {
            int success = -1;
            SqlCmd = "DELETE FROM tbl_rules WHERE id = " + id + ";";
